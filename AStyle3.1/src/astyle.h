...
public:
	static const string AS_IF;
	static const string AS_ELSE;

	static const string AS_DO;
	static const string AS_WHILE;

	static const string AS_FOR;
	static const string AS_SWITCH;
	static const string AS_CASE;
	static const string AS_DEFAULT;

	static const string AS_TRY;
	static const string AS_CATCH;
	static const string AS_THROW;
	static const string AS_THROWS;
	static const string AS_FINALLY;
	static const string AS_USING;

	static const string _AS_TRY;
	static const string _AS_FINALLY;
	static const string _AS_EXCEPT;

	static const string AS_PUBLIC;
	static const string AS_PROTECTED;
	static const string AS_PRIVATE;

	static const string AS_CLASS;
	static const string AS_STRUCT;
	static const string AS_UNION;
	static const string AS_INTERFACE;
	static const string AS_NAMESPACE;
	...
	static const string AS_EXTERN;
	static const string AS_ENUM;

	static const string AS_FINAL;
	static const string AS_OVERRIDE;

	static const string AS_STATIC;
	static const string AS_CONST;
	static const string AS_SEALED;
	static const string AS_VOLATILE;
	static const string AS_NEW;
	static const string AS_DELETE;

	static const string AS_NOEXCEPT;
	static const string AS_INTERRUPT;
	static const string AS_AUTORELEASEPOOL;

	static const string AS_WHERE;
	static const string AS_LET;
	static const string AS_SYNCHRONIZED;

	static const string AS_OPERATOR;
	static const string AS_TEMPLATE;

	static const string AS_OPEN_BRACE;
	static const string AS_CLOSE_BRACE;

	static const string AS_OPEN_LINE_COMMENT;
	static const string AS_OPEN_COMMENT;
	static const string AS_CLOSE_COMMENT;

	static const string AS_BAR_DEFINE;
	static const string AS_BAR_INCLUDE;
	static const string AS_BAR_IF;
	static const string AS_BAR_EL;
	static const string AS_BAR_ENDIF;

	static const string AS_AUTO;
	static const string AS_RETURN;

	static const string AS_CIN;
	static const string AS_COUT;
	static const string AS_CERR;

	static const string AS_ASSIGN;
	static const string AS_PLUS_ASSIGN;
	static const string AS_MINUS_ASSIGN;
	static const string AS_MULT_ASSIGN;

	static const string AS_DIV_ASSIGN;
	static const string AS_MOD_ASSIGN;
	static const string AS_XOR_ASSIGN;
	static const string AS_OR_ASSIGN;
	static const string AS_AND_ASSIGN;

	static const string AS_GR_GR_ASSIGN;
	static const string AS_LS_LS_ASSIGN;
	static const string AS_GR_GR_GR_ASSIGN;
	static const string AS_LS_LS_LS_ASSIGN;

	static const string AS_GCC_MIN_ASSIGN;
	static const string AS_GCC_MAX_ASSIGN;

	static const string AS_EQUAL;
	static const string AS_PLUS_PLUS;
	static const string AS_MINUS_MINUS;
	static const string AS_NOT_EQUAL;
	static const string AS_GR_EQUAL;

	static const string AS_LS_EQUAL;
	static const string AS_LS_LS_LS;
	static const string AS_LS_LS;
	static const string AS_GR_GR_GR;
	static const string AS_GR_GR;

	static const string AS_QUESTION_QUESTION;
	static const string AS_LAMBDA;

	static const string AS_ARROW;
	static const string AS_AND;
	static const string AS_OR;

	static const string AS_SCOPE_RESOLUTION;

	static const string AS_PLUS;
	static const string AS_MINUS;
	static const string AS_MULT;
	static const string AS_DIV;
	static const string AS_MOD;
	static const string AS_GR;
	static const string AS_LS;

	static const string AS_NOT;
	static const string AS_BIT_XOR;
	static const string AS_BIT_OR;
	static const string AS_BIT_AND;
	static const string AS_BIT_NOT;

	static const string AS_QUESTION;
	static const string AS_COLON;
	static const string AS_SEMICOLON;
	static const string AS_COMMA;

	static const string AS_ASM;
	static const string AS__ASM__;
	static const string AS_MS_ASM;
	static const string AS_MS__ASM;

	static const string AS_QFOREACH;
	static const string AS_QFOREVER;
	static const string AS_FOREVER;

	static const string AS_FOREACH;
	static const string AS_LOCK;
	static const string AS_UNSAFE;
	static const string AS_FIXED;

	static const string AS_GET;
	static const string AS_SET;
	static const string AS_ADD;
	static const string AS_REMOVE;

	static const string AS_DELEGATE;
	static const string AS_UNCHECKED;

	static const string AS_CONST_CAST;
	static const string AS_DYNAMIC_CAST;
	static const string AS_REINTERPRET_CAST;
	static const string AS_STATIC_CAST;

	static const string AS_NS_DURING;
	static const string AS_NS_HANDLER;
...
class EXPORT ASBase : protected ASResource
{
private:
...
class EXPORT ASBeautifier : protected ASBase
{
public:
	ASBeautifier();
